...
beforeEach(function() {
    ...
    CampaignMail::query()->create([ 'clicks' => 7, 'openings' => 0, 'campaign_id' => $this->campaign->id, 'subscriber_id' => $emailList->subscribers[0]->id, 'sent_at' => $this->campaign->sent_at ]);
    CampaignMail::query()->create([ 'clicks' => 5, 'openings' => 23, 'campaign_id' => $this->campaign->id, 'subscriber_id' => $emailList->subscribers[1]->id, 'sent_at' => $this->campaign->sent_at ]);
    CampaignMail::query()->create([ 'clicks' => 0, 'openings' => 54, 'campaign_id' => $this->campaign->id, 'subscriber_id' => $emailList->subscribers[2]->id, 'sent_at' => $this->campaign->sent_at ]);
});
