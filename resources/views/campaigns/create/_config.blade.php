...
<div class="grid grid-cols-2 gap-4">
    ...
    <div>
        ...
        <x-input.text id="email_list_id" class="block mt-1 w-full" name="email_list_id" :value="old('email_list_id', $data['email_list_id'])"
            autofocus />
    ...
    <div>
        ...
        <x-input.text id="template_id" class="block mt-1 w-full" name="template_id" :value="old('template_id', $data['template_id'])"
            autofocus />
    ...
    <div>
      ...
      <x-input.text id="track_click" class="block mt-1 w-full" name="track_click" :value="old('track_click', $data['track_click'])"
          autofocus />
    ...
    <div>
        ...
        <x-input.text id="track_open" class="block mt-1 w-full" name="track_open" :value="old('track_open', $data['track_open'])"
            autofocus />
