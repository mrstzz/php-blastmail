            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div>
                    <p class="mt-2 text-sm text-slate-700">
                        ...
                        <button form="send-verification" class="rounded-full text-sm font-semibold text-slate-500 underline decoration-slate-300 underline-offset-4 transition hover:text-slate-950 focus:outline-none focus:ring-2 focus:ring-emerald-400/60 focus:ring-offset-2">
